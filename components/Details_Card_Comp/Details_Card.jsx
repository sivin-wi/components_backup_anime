import {
    Styled_Main_Details_Card,Styled_Img,
    Styled_Container_One,Styled_Container_Three,Styled_Container_Two
} from './Details_Card_Styled'

export const Details_Card = ()=>{
 
    return(
      <>
       <Styled_Main_Details_Card>
          <Styled_Container_One>
            <Styled_Img alt='img'  src=''/>
          </Styled_Container_One>
          <Styled_Container_Two>
            {/*Note: h1 or any element will work 'ellipses'*/}
            {/* title */}
               {''}
          </Styled_Container_Two>
          <Styled_Container_Three>
